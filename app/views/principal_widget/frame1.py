...
class Frame1(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.bt_actualizar=Button(self, text='actualizar', font=('Arial',12,'bold'),width=12,bg='pink', command=self.actualizar_puertos)
       
        self.bt_actualizar.pack(pady=5,expand=1)
        
        self.bt_desconectar=Button(self, text='desconectar', font=('Arial',12, 'bold'), width=12,bg='pink', command=self.desconectar_serial )
